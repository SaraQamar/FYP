...
class Env(ShowBase):
	...
	f = loader.loadModel("models/ball1.egg")
        ...
        newTextNode2 = TextNode('text') # Create a new TextNode
        newTextNode2.setText(date) # Set the TextNode text
        newTextNode2.setAlign(TextNode.ACenter) # Set the text align
        newTextNode2.setWordwrap(12.0) 
        date_generate = newTextNode2.generate() 
     
	newTextNodePath = render.attachNewNode(text_generate) # Attach the NodePath to the render tree
        newTextNodePath2 = render.attachNewNode(date_generate)
        
        newTextNodePath.setPos(a,b,(c + 0.6))
        newTextNodePath.setColor(255, 0, 0,1)
        newTextNodePath.setScale(.5)
        
        newTextNodePath2.setPos(a,b,(c - 0.6))
        newTextNodePath2.setColor(255, 0, 0,1)
        newTextNodePath2.setScale(.5)
        return pos    
